<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden dark:bg-none dark:bg-card dark:text-foreground">
    <DecorativeCircles />
  ...
  <h1 class="text-foreground mb-2 text-center">Welcome Back</h1>
  <p class="text-muted text-center mb-6">Sign in to your account to continue</p>
