    ...
    <main class="flex-1 py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
              <h1 class="text-foreground mb-2">Tickets</h1>
              <p class="text-muted">
        ...
        <div class="mb-8">
          <div class="relative max-w-md">
            <Search class="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted w-5 h-5" />
            <VInput
              type="search"
        ...
        <div v-else class="text-center py-16">
          <div class="w-16 h-16 bg-card rounded-full flex items-center justify-center mx-auto mb-4">
            <TicketIcon class="w-8 h-8 text-muted" />
          </div>
