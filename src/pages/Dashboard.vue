  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <main class="flex-1 py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
          <h1 class="text-foreground mb-2">Dashboard</h1>
          <p class="text-muted">
          ...
          <VCard v-for="(stat, index) in stats" :key="index" class="p-6">
            <div class="flex items-start justify-between">
              <div>
                ...
                <p class="text-foreground">{{ stat.value }}</p>
              </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <VCard class="p-8 bg-gradient-to-br from-indigo-600 to-purple-600 text-white dark:bg-card dark:text-foreground">
            <h2 class="text-white dark:text-foreground mb-2">Manage Tickets</h2>
            <p class="text-indigo-100 dark:text-muted mb-6">
          ...
          <VCard class="p-8">
            <h2 class="text-foreground mb-2">In Progress</h2>
        ...
        <VCard class="p-6">
          <div class="flex items-center justify-between mb-6">
            <h2 class="text-foreground">Recent Tickets</h2>
          ...
          <div v-if="recentTickets.length > 0" class="space-y-4">
            ...
            >
              <div class="flex-1">
                <h3 class="text-foreground mb-1">{{ ticket.title }}</h3>
                <p class="text-muted line-clamp-1">{{ ticket.description }}</p>
              </div>
          ...
          <div v-else class="text-center py-12">
            <Ticket class="w-12 h-12 text-muted mx-auto mb-4" />
            <p class="text-muted mb-4">No tickets yet</p>
