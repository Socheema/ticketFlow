<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden py-12">
    <DecorativeCircles />
    ...
    <div class="w-full max-w-md px-4 relative z-10">
      ...
      <VCard class="p-8 shadow-xl">
        <h1 class="text-gray-900 mb-2 text-center">Create Account</h1>
        <p class="text-gray-600 text-center mb-6">Get started with TicketFlow today</p>
